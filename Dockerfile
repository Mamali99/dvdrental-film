...
COPY ./target/dvdrental-filmd-bootable.jar /usr/app/dvdrental-filmd-bootable.jar
...
CMD java -Djboss.bind.address=0.0.0.0 -Djboss.bind.address.management=0.0.0.0 -Djboss.http.port=8081 -jar /usr/app/dvdrental-filmd-bootable.jar -Dpostgresql.user=${POSTGRESQL_USER} -Dpostgresql.password=${POSTGRESQL_PASSWORD}
